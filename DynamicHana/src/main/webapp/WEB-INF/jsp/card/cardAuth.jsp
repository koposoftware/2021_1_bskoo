...
<script>
	$(document).ready(function() {
		...
		function checkPw() {
			$.ajax({
				'type' : 'post',
				'url' : '${pageContext.request.contextPath}/cardAuth',
				'data' : {
				...
				'success' : function(data) {
					...
					if (data == 1) {
						console.log('로그인성공')
						location.href="${pageContext.request.contextPath}/monthlyStmt"
					}else{
						alert('비밀번호가 일치하지 않습니다.')
						location.href="${pageContext.request.contextPath}/cardAuth"
					}
